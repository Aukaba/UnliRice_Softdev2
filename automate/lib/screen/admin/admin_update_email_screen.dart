                  ...
                  child: Row(
                    children: [
                      ...
                      Container(
                        ...
                        decoration: ShapeDecoration(
                          image: const DecorationImage(
                            image:
                                NetworkImage("https://placehold.co/98x98"),
                            fit: BoxFit.cover,
                          ),
                          shape: RoundedRectangleBorder(
                      ...
                      const Icon(Icons.notifications_outlined,
                          color: Color(0xFF19456B), size: 28),
                    ],
                  ),
                ),
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: ShapeDecoration(
                            ...
                            shape: RoundedRectangleBorder(
                              side: const BorderSide(
                                  width: 1, color: Color(0x3F26518E)),
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: ShapeDecoration(
                              ...
                              shape: RoundedRectangleBorder(
                                side: const BorderSide(
                                    width: 1, color: Color(0xFF2D5A85)),
                                borderRadius: BorderRadius.circular(25),
                              ),
                              shadows: const [
                                BoxShadow(
